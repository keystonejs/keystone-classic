...
describe('<AlertMessages />', () => {
	...
	it('should render a success Alert on success', () => {
	...
	it('should render "error" if no validation error is specified', () => {
	...
	it('should render a single validation error passed in a different format', () => {
		const errorPath = 'some/path';
