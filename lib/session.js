 ...
 * If it is a mongoose virtual field it may not be present in the database - double check you
 * user.js file to see how it is computed.
 *
 * @param {Object} req - express request object
 * @param req.user - The user object Keystone.List
 * @param req.user.canAccessKeystone - Virtual or boolean value
 * @param {Object} res - express response object
 * @param {function()} next callback
 */
