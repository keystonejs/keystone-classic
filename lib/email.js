...
var Email = function (options) {
	 ...
	 */
	// This behaviour has to be deprecated as a result of the below deprecation, so warn if people do
	// new keystone.Email('sometemplate.pug') as well!
	if (typeof options === 'string') {
		options = {
			templateName: options,
		};
	// This check needs to stay when the above branch is removed/warned for!
