var _ = require('underscore'),
	...
	Field = require('../fields/types/Type'),
...
function List(key, options) {
	...
	if (options && options.inherits) {
		this.parentList = require('../').list(options.inherits);
		defaultOptions = utils.options(defaultOptions, this.parentList.options);
	}
...
List.prototype.add = function() {
	...
	_.each(arguments, function(def) {
		list.schemaFields.push(def);
	});
};


List.prototype.attachAll = function() {
	if (this.parentList) {
		var parentFields = this.parentList.schemaFields;
		this.schemaFields = parentFields.concat(this.schemaFields);
	}
	...
	_.each(this.schemaFields, function(def) {
...
List.prototype.register = function() {
	...
	if (this.parentList) {
		this.model = this.parentList.model.discriminator(this.key, this.schema);
	} else {
