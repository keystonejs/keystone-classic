...
function List(key, options) {
	...
	// convert options.preview function to string (allow json encode)
	if (typeof this.options.preview == 'function') {
		this.options.preview = String(this.options.preview);
	} else if (typeof this.options.preview == 'object') {
		if (typeof this.options.preview.available == 'function') {
			this.options.preview.available = String(this.options.preview.available);
		}
		if (typeof this.options.preview.path == 'function') {
			this.options.preview.path = String(this.options.preview.path);
		}
	}
