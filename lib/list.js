...
List.prototype.register = function() {
	...
	// add the parent id to the schema, if it has been defined
	/* TODO: Not sure we will implement this... Relationship fields may suffice.
	var parent = this.get('parent');
	if (parent) {
		this.schema.add({
			parent: { type: keystone.mongoose.Schema.Types.ObjectId, ref: parent }
		});
		schema.virtual('parentList').get(function () {
			return list.parent;
		});
	}
	*/
