...
module.exports = function(keystone) {
	...
	var schemaPlugins = require('./schemaPlugins')(keystone);
	...
	List.prototype.register = require('./list/register')(keystone);
	List.prototype.relationship = require('./list/relationship')(keystone);
