...
function List(key, options) {
	...
	Object.defineProperty(this, 'nameIsInitial', { get: function() {
		return (this.fields[this.mappings.name] && this.initialFields.indexOf(this.fields[this.mappings.name]) < 0);
	}});
	...
	Object.defineProperty(this, 'initialFields', { get: function() {
		return initialFields || (initialFields = _.filter(this.fields, function(i) {
			return i.initial || (i.required && i.default === undefined);
		}));
	}});
