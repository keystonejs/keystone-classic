...
function List(key, options) {
	...
	Object.defineProperty(this, 'customActions', { get: function() {
		return _.map(this._customActions, function(customAction) {
			return _.omit(customAction, 'callback');
		});
	} });
...
List.prototype.customAction = require('./list/customAction');
