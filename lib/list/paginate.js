...
function paginate (options, callback) {
	if (!this.keystone.__deprecationsWarned.paginate) {
		this.keystone.__deprecationsWarned.paginate = true;
		console.warn('WARNING: List.paginate is no longer supported. It will will be deprecated in keystone 5')
	};
	var list = this;
