...
function relationship(list, path, options) {
	...
	// TODO: implement initial form for many:true relationships, usage disabled for now
	if (this.many && options.initial) {
		throw new Error('Invalid Configuration\n\n' +
			'Relationship fields with many:true (' + list.key + '.' + path + ') do not currently support being used as initial fields.\n');
	}
