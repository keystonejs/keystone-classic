...
location.prototype.addToSchema = function() {
	...
	['googleLookup', 'kmFrom', 'milesFrom'].forEach(function(method) {
...
function doGoogleGeocodeRequest(address, region, callback) {
	...
	//- TODO - Support passing an API key for enterprise licenses.
	// var endpoint = 'https://maps.googleapis.com/maps/api/geocode/json?key=' + process.env.GOOGLE_PLACES_API_KEY + '&' + querystring.stringify(options);
