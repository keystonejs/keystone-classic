 ...
 * @api public
 */
image.prototype.delete = function(item) {
 ...
 * @api public
 */
image.prototype.reset = function(item) {
 ...
 * @api public
 */
image.prototype.getRequestHandler = function(item, req, callback) {
	...
	return function() {
		...
		if (req.files && req.files[field.paths.upload] && req.files[field.paths.upload].size) {
			...
			var tp = prospekt.get('cloudinary prefix') || '';
			...
			if (prospekt.get('cloudinary prefix'))
				uploadOptions.tags.push(prospekt.get('cloudinary prefix'));
 ...
 * @api public
 */
image.prototype.handleRequest = function(item, req, callback) {
