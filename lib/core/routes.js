...
function routes(app) {
	...
	if (this.get('auth') === true) {
		...
		if(!this.get('resetpassword url')){
			this.set('resetpassword url', '/keystone/resetpassword');
		}
		app.all(this.get('resetpassword url'), require('../../routes/views/resetpassword'));
		
		if(!this.get('changepassword url')){
			this.set('changepassword url', '/keystone/changepassword');
		}
		app.all(this.get('changepassword url')+'/:token', require('../../routes/views/changepassword'));
