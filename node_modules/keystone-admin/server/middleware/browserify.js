...
var fieldComponents = require('keystone/lib/fieldComponents');
...
var vFiles = [
  new File({
    contents: new Buffer(fieldComponents.generateJSForComponentType('Filter', function(x) { return x.toLowerCase(); })),
    path: 'builtin-filters',
    base: basedir
  }),
  new File({
    contents: new Buffer(fieldComponents.generateJSForComponentType('Field', function(x) { return x.toLowerCase(); })),
    path: 'builtin-fields',
    base: basedir
  }),
  new File({
    contents: new Buffer(fieldComponents.generateJSForComponentType('Column', function(x) { return x.toLowerCase(); })),
