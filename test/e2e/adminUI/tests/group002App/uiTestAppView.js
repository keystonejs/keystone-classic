module.exports = {
	...
	'AdminUI app should have a home icon link': function (browser) {
		browser.adminUIApp.assertElementHasAttribute({element: 'homeIconLink', attribute: 'title', text: 'Dashboard - e2e'});
	},
	...
	'AdminUI app should have a Front Page link': function (browser) {
		browser.adminUIApp.assertElementHasAttribute({element: 'frontPageIconLink', attribute: 'title', text: 'Front page - e2e'});
	},
	...
	'AdminUI app should have a Logout link': function (browser) {
		browser.adminUIApp.assertElementHasAttribute({element: 'logoutIconLink', attribute: 'title', text: 'Sign Out'});
	},
