...
describe('List "track" option', function () {
	...
	describe('when simulating "standard meta"', function () {
		...
		describe('using updateHandler()', function () {
			...
			it('should have mappings for createdOn/UpdatedOn', function () {
                          console.log('Test object', Test.map('createdOn'));
				demand(Test.map('createdOn')).be('createdAt');
				demand(Test.map('updatedOn')).be('updatedAt');
			});

			it('should updated all fields/mappings when adding a document', function(done) {
				...
				request(app)
					...
					.end(function(err, res){
						...
						demand(post.get('createdOn')).equal(post.get('createdAt'));
						demand(post.get('updatedOn')).equal(post.get('updatedAt'));
						done();
					});
