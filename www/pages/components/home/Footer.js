			...
			<div className={compose(styles.background)}>
				<Container>
					...
					<ul className={compose(styles.list_links)}>
						<li className={compose(styles.list_links_item)}><Link to="" className={compose(styles.list_links_anchor)}>Getting Started</Link></li>
						<li className={compose(styles.list_links_item)}><Link to="" className={compose(styles.list_links_anchor)}>Documentation</Link></li>
