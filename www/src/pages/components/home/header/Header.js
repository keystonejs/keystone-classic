			...
			<div className={compose(styles.wrapper)}>
				<Container>
					<div className={compose(styles.intro)}>
						...
						<h1 className={compose(styles.intro__title)}>
              Node.js CMS & web application platform
            </h1>
						<p className={compose(styles.intro__lead)}>
              ...
              >
                Get Started
							...
							{' '}
							<a
								href="https://demo.keystonejs.com"
								className={compose(
                  styles.button_home,
                  styles.button_home_inverse
                )}
              >
                Try the Demo
              </a>
						...
						<ul className={compose(styles.list_links)}>
							<li className={compose(styles.list_item)}>
                Current Version {version}
							</li>
							<li className={compose(styles.list_links_item)}>
								<a
                ...
                Free and Open Source (MIT)
						...
						<ul className={compose(styles.list_links)}>
							<li className={compose(styles.list_links_item)}>
								<EntypoDocuments />
								{' '}
								<Link to="/documentation" style={{ color: 'white' }}>
                  Read the Documentation
							...
							<li className={compose(styles.list_links_item)}>
								<a
									...
									style={{ color: 'white' }}
                >
									<EntypoTwitter /> Follow @KeysoneJS on Twitter
                </a>
							</li>
							<li className={compose(styles.list_links_item)}>
								<a
									href="http://github.com/keystonejs/keystone"
									style={{ color: 'white' }}
                >
									<EntypoGithub /> Star on GitHub
                </a>
							</li>
						</ul>
						<p className={compose(styles.heading_text)}>
              Keystone powers websites, apps and APIs for:
            </p>
						<div className={compose(styles.home_header_brands)}>
							<img
								src={continental}
								className={compose(styles.header_brand_img)}
              />
