...
/**
 * MultiSelect FieldType Constructor
 * @extends Field
 * @api public
 */
function multiselect (list, path, options) {
	...
	this.ops = options.options.map(function (i) {
		var op = { value: i.trim(), label: utils.keyToLabel(i) };
		return op;
	});
	...
	multiselect.super_.call(this, list, path, options);
}
multiselect.properName = 'MultiSelect';
util.inherits(multiselect, FieldType);

/**
 * Formats the field value
 */
multiselect.prototype.format = function (item, separator) {
 ...
 */
multiselect.prototype.addFilterToQuery = function (filter) {
	var query = {};
 ...
 */
multiselect.prototype.validateInput = function (data, callback) {
 ...
 */
multiselect.prototype.validateRequiredInput = function (item, data, callback) {
	var value = this.getValueFromData(data);
	var result = false;
 ...
 * Deprecated
 */
multiselect.prototype.inputIsValid = function (data, required, item) {
	var value = this.getValueFromData(data);
	if (required) {
 ...
 */
multiselect.prototype.updateItem = function (item, data, callback) {
	var value = this.getValueFromData(data);
	if (value === undefined || value === null || value === '') {
		value = [];
	}
