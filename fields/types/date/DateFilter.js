...
var DateFilter = React.createClass({
	...
	renderToggle () {
		...
		const options = (field.type === 'datearray') ? TOGGLE_OPTIONS_CONTAINS : TOGGLE_OPTIONS;
		return (
			<FormField>
				<SegmentedControl equalWidthSegments options={options} value={filter.inverted} onChange={this.toggleInverted} />
			</FormField>
		);
	},
